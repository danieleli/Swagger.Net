...
(function () {
	...
	SwaggerUi = (function (_super) {
		...
		SwaggerUi.prototype.load = function () {
			var _ref;
			if ((_ref = this.mainView) != null) _ref.clear();
		...
		SwaggerUi.prototype.render = function () {
			...
			if (this.options.onComplete) this.options.onComplete(this.api, this);
		...
		SwaggerUi.prototype.onLoadFailure = function (data) {
			...
			if (this.options.onFailure != null) this.options.onFailure(data);
			return val;
		};
	...
	HeaderView = (function (_super) {
		...
		HeaderView.prototype.showCustomOnKeyup = function (e) {
			if (e.keyCode === 13) return this.showCustom();
		};
	...
	OperationView = (function (_super) {
		...
		OperationView.prototype.render = function () {
			...
			if (!isMethodSubmissionSupported) this.model.isReadOnly = true;
		...
		OperationView.prototype.submitOperation = function (e) {
			var bodyParam, error_free, form, headerParams, invocationUrl, map, o, obj, param, _i, _j, _len, _len2, _ref, _ref2,
		_this = this;
			if (e != null) e.preventDefault();
			...
			if (error_free) {
				...
				for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
					param = _ref2[_j];
					if (param.paramType === 'body') bodyParam = map[param.name];
				}
	...
	ParameterView = (function (_super) {
		...
		ParameterView.prototype.render = function () {
			var template;
			if (this.model.paramType === 'body') this.model.isBody = true;
